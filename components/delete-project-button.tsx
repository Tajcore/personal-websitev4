...
export function DeleteProjectButton({ projectId, projectTitle }: DeleteProjectButtonProps) {
  ...
  const handleDelete = async () => {
    ...
    // Delete project skills first (cascade should handle this, but being explicit)
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Are you sure you want to delete &quot;{projectTitle}&quot;? This will also delete the associated case study.
